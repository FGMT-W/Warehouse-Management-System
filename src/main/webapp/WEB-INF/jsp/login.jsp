...
<head>
	...
	<title>仓储出库管理系统登录</title>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/model/login/login.css">
</head>
<body>
<!-- 定义容器 -->
<div class="container">
				...
				<div class="panel-body">
					...
					<form id="login_form" class="form-horizontal" style="">
						...
						<div>
							...
							<div class="col-md-4 col-sm-4"><button id="submit" type="submit" class="btn btn-primary">
								&nbsp;&nbsp;&nbsp;&nbsp;Login&nbsp;&nbsp;&nbsp;&nbsp;</button></div>
							<div class="col-md-4 col-sm-4"></div>
						</div>
					</form>
