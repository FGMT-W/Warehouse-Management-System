    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <a href="javascript:void(0)" class="navbar-brand home">仓储出库管理系统</a>
            </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a href="#collapse4" data-toggle="collapse" data-parent="#accordion"
                                   class="parentMenuTitle collapseHead">基础数据管理</a>
                                <div class="pull-right	">
                                    <span class="caret"></span>
                                </div>
                            </h4>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a href="#collapse6" data-toggle="collapse" data-parent="#accordion"
                               class="parentMenuTitle collapseHead">仓储环境信息</a>
                            <div class="pull-right">
                                <span class="caret"></span>
                            </div>
                        </h4>
                        ...
                        <div class="panel-body">
                            <shiro:hasRole name="systemAdmin">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <a href="javascript:void(0)" id="" class="menu_item"
                                           name="pagecomponent/repoTempHumRecord.jsp">查看仓储温湿度</a>
                                    </li>
                                </ul>
                            </shiro:hasRole>
                            <shiro:hasRole name="commonsAdmin">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <a href="javascript:void(0)" id="" class="menu_item"
                                           name="pagecomponent/repoTempHumManagement.jsp">仓储温湿度管理</a>
                                    </li>
                                </ul>
                            </shiro:hasRole>
                        </div>
